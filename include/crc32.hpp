 ...
 *
 */
static const size_t kChecksumSize = 4;

/**
 * @brief Memoized CRC32 Table.
 *
 */
...
/**
 * @brief Implementation of the CRC32 cyclic redundancy check.
 *
 * @param data
 * @param length
 * @return uint32_t
...
inline uint32_t CRC32(const uint8_t* data, size_t length) {
  ...
  for (size_t i = 0; i < length; i++) {
    ...
    crc32 = (crc32 >> 8) ^ kCRC32Table[lookup_index];
  }

  // invert the bits to get the final crc32 value.
  crc32 ^= 0xFFFFFFFFU;
